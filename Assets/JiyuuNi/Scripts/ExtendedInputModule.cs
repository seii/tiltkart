...
namespace UnityEngine.EventSystems
{
    ...
    /// Also works with TiltFive Wand controller in Wand Mode.
    /// </summary>
    /// <remarks>
    ...
    public class ExtendedInputModule : PointerInputModule
    {
        ...
        {
            /*if(m_CurrentFocusedGameObject == null || !m_CurrentFocusedGameObject.activeInHierarchy)
            {
                Debug.Log("Updating active canvas");
                UpdateActiveCanvas();
            }*/
            ...
            foreach (Canvas canvas in canvases)
            {
                if (canvas.isActiveAndEnabled)
                {
                    ...
                    m_CurrentFocusedGameObject =
                        activeCanvas.GetComponentsInChildren<Button>()[0].gameObject;
                    break;
                }
            }
        }
