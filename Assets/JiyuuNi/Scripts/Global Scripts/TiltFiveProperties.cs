...
public class TiltFiveProperties : MonoBehaviour
{
    ...
    {
        print($"{thisClass}: Updated follow object to {newFollowObject.name}");
    ...
    private void Follow()
    {
        //print($"{thisClass}: Starting Follow");
        ...
        if(followObject != null)
        {
            ...
            //print($"{thisClass}: rotation = {board.rotation.eulerAngles.y}");
        }
    }
